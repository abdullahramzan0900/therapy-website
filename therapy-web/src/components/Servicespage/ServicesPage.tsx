...
const IndividualTherapy = () => {
  return (
    <section className={styles.individualTherapySection}>
      ...
      <p>
        Individual therapy is a dedicated space where you can explore your emotions, challenges,
        and experiences with a trained professional. Whether you are facing difficulties in your
        personal life, struggling with mental health concerns, or simply need support to navigate a
